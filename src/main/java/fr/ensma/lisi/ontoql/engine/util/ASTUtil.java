...
/**
 * Provides utility methods for AST traversal and manipulation. Extract from the
 * hibernate framework
 * 
...
public final class ASTUtil {
	 ...
	 */
	public static List findAllTypeInChildren(final AST parent, final int type) {
	 ...
	 * @param n   node
	 */
	private static void getPathText(final StringBuffer buf, final AST n) {
	 ...
	 */
	public static List collectChildren(final AST root, final FilterPredicate predicate) {
	 ...
	 * @param predicate predicate
	 */
	private static void collectChildren(final List children, final AST root, final FilterPredicate predicate) {
	 ...
	 */
	public static List collectDirectChildren(final AST node) {
		List children = new ArrayList();
