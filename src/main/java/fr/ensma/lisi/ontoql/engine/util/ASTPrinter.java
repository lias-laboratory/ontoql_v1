...
public class ASTPrinter {
	 ...
	 * @param ast     ?
	 */
	private void showAst(final ArrayList<AST> parents, final PrintWriter pw, final AST ast) {
		if (ast == null) {
	 ...
	 * @param buf  buffer
	 */
	public static final void appendEscapedMultibyteChars(final String text, final StringBuffer buf) {
