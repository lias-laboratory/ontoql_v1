...
import fr.ensma.lisi.ontoql.engine.antlr.OntoQLBaseParser;
...
/**
 * Implements the semantic action methods defined in the OntoQL base parser to
 * keep the grammar source file a little cleaner. Extends the parser class
 * generated by ANTLR.
 * 
 * @author Stéphane JEAN
 */
public final class OntoQLParser extends OntoQLBaseParser {

	/**
	 * A logger for this class.
	 */
	private static Log log = LogFactory.getLog(OntoQLParser.class);
	...
	private static ASTPrinter getASTPrinter() {
		return new ASTPrinter(fr.ensma.lisi.ontoql.engine.antlr.OntoQLTokenTypes.class);
	}
	 ...
	 */
	public static OntoQLParser getInstance(final String ontoql) {
		OntoQLLexer lexer = new OntoQLLexer(new StringReader(ontoql));
		return new OntoQLParser(lexer);
	}
	 ...
	 */
	private OntoQLParser(final TokenStream lexer) {
		super(lexer);
		initialize();
	}
