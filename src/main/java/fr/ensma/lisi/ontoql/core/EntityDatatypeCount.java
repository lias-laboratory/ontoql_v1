 ...
 */
public abstract class EntityDatatypeCount extends AbstractEntityDatatype {

	public EntityDatatypeCount() {
	}
	...
	public abstract void postInsert(String propertyIdentifier) throws JOBDBCException;

	public abstract String getExtent(String propertyIdentifier) throws JOBDBCException;
}
