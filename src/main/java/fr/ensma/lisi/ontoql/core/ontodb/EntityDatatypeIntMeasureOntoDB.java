 ...
 */
public class EntityDatatypeIntMeasureOntoDB extends AbstractEntityDatatype {
	...
	public EntityDatatypeIntMeasureOntoDB(OntoQLSession session) {
	...
	public String getTableName() {
		return OntoDBHelper.INT_MEASURE_TYPE_TABLE;
	}
