...
import fr.ensma.lisi.ontoql.core.EntityDatatypeBoolean;
 ...
 */
public class EntityDatatypeBooleanOntoDB extends EntityDatatypeBoolean {
	...
	public EntityDatatypeBooleanOntoDB(OntoQLSession session) {
		this.session = session;
	}

	@Override
	public String getTableName() {
		return OntoDBHelper.BOOLEAN_TYPE_TABLE;
	}
