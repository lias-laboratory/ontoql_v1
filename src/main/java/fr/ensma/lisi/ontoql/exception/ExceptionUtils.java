...
public final class ExceptionUtils {
	 ...
	 * </p>
	 * 
	 * @param methodName the methodName to add to the list, <code>null</code> and
	 ...
	 * Arrays.asList(CAUSE_METHOD_NAMES ); list.add(methodName); CAUSE_METHOD_NAMES
	 ...
	 * <p/>
	 * <p>
	 * This method walks through the exception chain to the last element, "root" of
	 * the tree, using {@link #getCause(Throwable)}, and returns that exception.
	 * </p>
	 * 
	 ...
	 * @param throwable the throwable to inspect, may be null
	 * @param type      the type to search for
	 * @param fromIndex the (zero based) index of the starting position, negative
	 ...
	 * <p/>
	 * <p>
	 * The compact stack trace starts with the root cause and prints stack frames up
	 ...
	 * <p/>
	 * <p>
	 * The method is equivalent to <code>printStackTrace</code> for throwables that
	 * don't have nested causes.
	 * </p>
	 * 
