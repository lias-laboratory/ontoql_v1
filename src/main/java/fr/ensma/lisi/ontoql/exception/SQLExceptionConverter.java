 ...
 * SQLException into Ontoql's JDBCException hierarchy.
 * <p/>
...
public interface SQLExceptionConverter {
	...
	/**
	 * Convert the given SQLException into Ontoql JDBCException hierarchy.
	 * 
	 * @param sqlException The SQLException to be converted.
	 * @param message      An optional error message.
	 * @return The resulting JDBCException.
	 * @see ConstraintViolationException, JDBCConnectionException,
	 *      SQLGrammarException, LockAcquisitionException
	 */
