...
public class NestableDelegate implements Serializable {
	...
	private static final long serialVersionUID = -9028497211933181953L;

	/**
	 * Constructor error message.
	 */
	private static final String MUST_BE_THROWABLE = "The Nestable implementation passed to the NestableDelegate(Nestable) "
			+ "constructor must extend java.lang.Throwable";

	/**
	 * Holds the reference to the exception or error that we're wrapping (which must
	 * be a {@link org.apache.commons.lang.exception.Nestable} implementation).
	 */
	 ...
	 * 
	 * @param baseMsg the base message to use when creating the full message. Should
	 ...
	 * <code>Throwable</code>s in an array of <code>Throwable</code>s, one element
	 * for each <code>Throwable</code>.
	 * 
	 ...
	 * matches the specified type in the chain of <code>Throwable</code>s held in
	 * this delegate's <code>Nestable</code> with an index greater than or equal to
	 * the specified index, or -1 if the type is not found.
	 * 
	 ...
	 * Throwable class has a <code>getCause</code> method (i.e. running on jre1.4 or
	 * higher), this method just uses Throwable's printStackTrace() method.
	 * Otherwise, generates the stack-trace, by taking into account the 'topDown'
	 * and 'trimStackFrames' parameters. The topDown and trimStackFrames are set to
	 * 'true' by default (produces jre1.4-like stack trace).
	 * 
	...
	/**
	 * Captures the stack trace associated with the specified <code>Throwable</code>
